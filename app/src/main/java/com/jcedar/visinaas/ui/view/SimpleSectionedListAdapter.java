package com.jcedar.visinaas.ui.view;
...
/**
 * Created by Splashers on 29/04/2014.
 */
...
public class SimpleSectionedListAdapter extends BaseAdapter {
    ...
    private boolean mIsLineDivided;
    ...
    public SimpleSectionedListAdapter(Context context, int sectionResourceId,
                                      ListAdapter baseAdapter, boolean dividerIsALine) {
        mLayoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mSectionResourceId = sectionResourceId;
        mIsLineDivided = dividerIsALine;
        mBaseAdapter = baseAdapter;
        mBaseAdapter.registerDataSetObserver(new DataSetObserver() {
            @Override
            public void onChanged() {
